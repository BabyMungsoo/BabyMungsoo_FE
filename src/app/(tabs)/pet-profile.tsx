  ...
  return (
    ...
    >
      ...
      <View className="flex-1 gap-4 px-5 pt-2">
        {/* 프로필 카드 */}
        <View
          className="items-center rounded-2xl bg-paper-card p-6"
          style={CARD_SHADOW}
        >
          ...
          <Text className="mt-4 text-xl font-bold text-ink">
            {pet.name}
          </Text>
...
function Header({
  ...
  return (
    <View className="relative h-14 flex-row items-center justify-center px-5">
      <Pressable
        onPress={() =>
          router.replace('/my-page' as never)
        }
...
function InfoRow({
  ...
  return (
    <View className="flex-row items-center justify-between py-3">
      ...
      <Text className="max-w-[65%] text-right text-sm font-semibold text-ink">
        {value}
      </Text>
    </View>
  );
